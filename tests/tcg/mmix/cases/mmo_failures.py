...
MMO_FORMAT_FAILURE_TESTS = [
    ...
    MMIXLoaderFailure(
        "mmo-tetra-outside-hosted-segments",
        mmo_image([mmo_loc(MMIX_HOSTED_LIMIT), halt()]),
        ("invalid MMIX .mmo lop_loc range at 0x8000000000000000",
    ...
    MMIXLoaderFailure(
        ...
        mmo_image(
            [mmo_lop(MMIX_MMO_LOP_FIXRX, 16),
             struct.pack(">I", 0x00010000)]
        ),
        ("invalid MMIX .mmo lop_fixrx delta 0x00010000 for 16-bit "
         "relative fixup", "tetra 2"),
    ),
    MMIXLoaderFailure(
        "mmo-fixrx-target-before-zero",
        mmo_image(
            [mmo_lop(MMIX_MMO_LOP_FIXRX, 16), struct.pack(">I", 1)]
        ),
    ...
    MMIXLoaderFailure(
        ...
        mmo_image(
            [mmo_lop(MMIX_MMO_LOP_POST, 0, y=0, z=255),
             struct.pack(">I", 0)]
        ),
    ...
    MMIXLoaderFailure(
        ...
        mmo_image([mmo_post(R255, {R255: 0}), halt()]),
    ...
    MMIXLoaderFailure(
        ...
        ("unsupported MMIX .mmo data after lop_end", "tetra 7"),
    ),
]
