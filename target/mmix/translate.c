...
static void gen_complete_instruction(DisasContext *ctx,
                                     TCGv_i64 continuation)
{
    gen_helper_mmix_complete_instruction(
...
static void gen_goto_tb(DisasContext *ctx, unsigned tb_slot_idx, vaddr dest)
{
    ...
    gen_complete_instruction(ctx, tcg_constant_i64(dest));
...
static bool gen_go(DisasContext *ctx, arg_xyz *a, bool immediate)
{
    ...
    gen_complete_instruction(ctx, dest);
