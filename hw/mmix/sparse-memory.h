...
#define MMIX_SPARSE_TEXT_BASE  UINT64_C(0x0000000000000000)
#define MMIX_SPARSE_DATA_BASE  UINT64_C(0x2000000000000000)
#define MMIX_SPARSE_POOL_BASE  UINT64_C(0x4000000000000000)
#define MMIX_SPARSE_STACK_BASE UINT64_C(0x6000000000000000)
#define MMIX_SPARSE_LIMIT      UINT64_C(0x8000000000000000)
