...
#define MMIX_VIRT_FLASH0_BASE      UINT64_C(0x0001000000000000)
#define MMIX_VIRT_FLASH1_BASE      UINT64_C(0x0001000004000000)
#define MMIX_VIRT_FLASH_BANK_SIZE  UINT64_C(0x0000000004000000)
#define MMIX_VIRT_FLASH_SECTOR_SIZE UINT64_C(0x0000000000040000)
#define MMIX_VIRT_FLASH_RESERVED_BASE UINT64_C(0x0001000008000000)
#define MMIX_VIRT_FLASH_APERTURE_END  UINT64_C(0x0001000010000000)

enum {
    MMIX_VIRT_FLASH_BANK_COUNT = 2,
};
